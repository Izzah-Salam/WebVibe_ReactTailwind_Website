...
export default function Experts() {
  return (
    <>
      <div className="max-w-[1240px] md:grid grid-cols-2 m-10">
        ...
        <div className="col-span-1 flex flex-col justify-center ">
          ...
          <button className=" lg:w-[30%] md:w-[50%] sm:w-[30%]  text-white border-0 my-2 py-2 md:px-8 px-5  focus:outline-none bg-[#743671] rounded text-lg">
            Get Started
          </button>
        </div>
      </div>
